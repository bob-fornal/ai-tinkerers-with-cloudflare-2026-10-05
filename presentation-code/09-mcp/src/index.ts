// Phase 9 (bonus) -- an MCP server on Workers, adopted near-verbatim from
// base-code/cloudflare-mcp (real, working code, not derived from the
// guideline doc alone). A stateless MCP handler (createMcpHandler, not the
// deprecated McpAgent) registers one resource and one tool, both reading
// from a Durable Object used as pure storage -- see learnings-hub.ts.
